...
namespace Live2D.Cubism.Editor.Inspectors
{
    ...
    internal sealed class CubismRendererInspector : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            renderer.MaxBufferTexture = EditorGUILayout.ObjectField("MaxZbuffer Texture", renderer.MaxBufferTexture, typeof(Texture2D), true) as Texture2D;
            renderer.MinXBuffer = EditorGUILayout.ObjectField("MinZbuffer Texture", renderer.MinXBuffer, typeof(Texture2D), true) as Texture2D;
