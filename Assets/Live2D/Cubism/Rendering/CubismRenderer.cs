...
namespace Live2D.Cubism.Rendering
{
    ...
    public sealed class CubismRenderer : MonoBehaviour
    {
        ...
        [SerializeField, HideInInspector]
        private Texture2D _minXBufferTexture;

        /// <summary>
        /// <see cref="MeshRenderer"/>'s main texture.
        /// </summary>
        public Texture2D MinXBuffer
        {
            get { return _minXBufferTexture; }
            set
            {
                // Return early if same value given and main texture is valid.
                if (value == _minXBufferTexture && _minXBufferTexture != null)
                {
                    return;
                }
        ...
        /// </summary>
        [SerializeField, HideInInspector]
        private Texture2D _maxZBufferTexture;

        /// <summary>
        /// <see cref="MeshRenderer"/>'s main texture.
        /// </summary>
        public Texture2D MaxBufferTexture
        {
            get { return  _maxZBufferTexture; }
            set
            {
                // Return early if same value given and main texture is valid.
                if (value == _maxZBufferTexture && _maxZBufferTexture != null)
                {
                    return;
                }
        ...
        private void ApplyMainTexture()
        {
            ...
            if (_minXBufferTexture != null)
            {
                SharedPropertyBlock.SetTexture(CubismShaderVariables.MinZbuffTexture, MinXBuffer);
            }

            if (MaxBufferTexture != null)
            {
                SharedPropertyBlock.SetTexture(CubismShaderVariables.MaxZbuffTexture, MaxBufferTexture);
            }
